...
// Source: github.com/40grivenprog/simple-bank/db/sqlc (interfaces: Store)
...
func (m *MockStore) GetSession(arg0 context.Context, arg1 uuid.UUID) (db.GetSessionRow, error) {
	m.ctrl.T.Helper()
