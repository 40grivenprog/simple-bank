...
SELECT sessions.id, sessions.username, sessions.refresh_token, sessions.user_agent, sessions.client_ip, sessions.is_blocked, sessions.expires_at, sessions.created_at, users.role FROM sessions
JOIN users
